...
class Animal(models.Model):
    ...
    mark_id = models.IntegerField(unique=True, null=True, blank=True)
    date_sterilization = models.CharField(max_length=30, blank=True, null=True)
    socialized = models.BooleanField()
    admission_id = models.CharField(max_length=20, unique=True, blank=True, null=True)
    admission_id_date = models.DateField(blank=True, null=True)
    catch_id = models.CharField(max_length=20, blank=True, null=True)
    ...
    knock_out_id = models.CharField(unique=True, max_length=20, blank=True, null=True)
